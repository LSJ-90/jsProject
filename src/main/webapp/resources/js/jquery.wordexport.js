    ...
    (function($) {
        $.fn.wordExport = function(fileName) {
            ...
            for (var i = 0; i < img.length; i++) {
                ...
                // console.log("달러 이미지 :", typeof $(img[i]));
                // console.log("그냥 이미지: ", typeof img[i]);
                img[i].width = w;
                img[i].height = h;
            ...
            var fileContent = defalut.mhtml.top.replace("_html_", defalut.mhtml.head.replace("_styles_", styles) + defalut.mhtml.body.replace("_body_", markup.html())) + mhtmlBottom;
